...
public class DarkGolemModel<T extends DarkGolemEntity> extends HierarchicalModel<T> {
    ...
    public DarkGolemModel(ModelPart pRoot) {
        this.root = pRoot;
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(BladesEdge.MOD_ID, "dark_golem"), "main");
